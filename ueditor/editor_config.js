...
toolbars: [
['Indent','Bold','Italic','Underline','BlockQuote','Horizontal','InsertUnorderedList','InsertOrderedList','RemoveFormat','FullScreen']
],
labelMap: {
'indent':'首行缩进','bold':'加粗','italic':'斜体','underline':'下划线','blockquote':'引用','horizontal':'水平线','insertunorderedlist':'无序列表','insertorderedlist':'有序列表','removeformat':'清除格式','fullscreen':'全屏'
},
iframeUrlMap: {
...
'body{margin:8px;font:13px/22px Helvetica Neue,Helvetica,Arial,Sans-serif}' +
'li{clear:both}' +
'p{margin:.5em 0}',
initialContent: '',
